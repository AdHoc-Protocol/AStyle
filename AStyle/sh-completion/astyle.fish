...
complete -c astyle -l style -xa 'allman java kr stroustrup whitesmith vtk ratliff gnu linux horstmann 1tbs google mozilla webkit pico lisp none' -d 'Set a formatting and indenting style'
complete -c astyle -l indent -xa 'spaces tab force-tab force-tab-x none' -d 'Set indentation option'
...
complete -c astyle -l pad-negation -xa 'before' -d 'Insert space padding after negations'
complete -c astyle -l pad-type-colon -xa 'after all none' -d 'Scala: set the space padding around a type colon'
complete -c astyle -l align-declarations -d 'Align consecutive declarations in columns'
complete -c astyle -l align-assignments -d 'Align the operators of consecutive assignments'
complete -c astyle -l align-comments -d 'Align the trailing comments of consecutive lines'
complete -c astyle -l sort-imports -d 'Sort consecutive imports'
complete -c astyle -l sort-modifiers -d 'Sort the modifiers of a declaration'
complete -c astyle -l scala3-syntax -d 'Scala: convert the conditions to the Scala 3 syntax'
complete -c astyle -l trailing-commas -xa 'always never' -d 'Insert or remove the trailing comma of a list spanning lines'
complete -c astyle -l scala3-end-markers -x -d 'Scala: insert end markers after definitions of # lines or more'
complete -c astyle -l pad-closure-braces -xa 'none' -d 'Scala: the spaces inside the braces of a one-line lambda'
complete -c astyle -l pad-block-braces -xa 'none' -d 'Scala: the spaces inside the braces of a one-line block'
complete -c astyle -l pad-import-braces -xa 'none' -d 'Scala: the spaces inside the braces of import selectors'
complete -c astyle -l pad-brace-call -xa 'none' -d 'Scala: the space before the brace of a method call'
complete -c astyle -l pad-pattern-at -xa 'none' -d 'Scala: the spaces around the @ of a pattern'
complete -c astyle -l pad-include -xa 'none' -d 'Insert space padding after include directives'
complete -c astyle -l pad-paren -xa 'in out none' -d 'Insert space padding around parenthesis on the outside, the inside, or both'
...
complete -c astyle -l pad-brackets -xa 'in out none' -d 'Insert space padding around square brackets on the outside, the inside, or both'
complete -c astyle -l pad-semicolon -xa 'none' -d 'Remove space padding before a semicolon'
...
complete -c astyle -l break-elseifs -xa 'no-indent' -d 'Break \'else if()\' statements into two different lines'
complete -c astyle -l break-one-line-headers -d 'Break one line headers (e.g'
complete -c astyle -l line-between-members -xa 'all' -d 'Insert an empty line between class/struct method definitions and between top-level functions'
...
complete -c astyle -l remove-braces -xa 'one-line' -d 'Remove braces from braced conditional statements (=one-line: one-line blocks only, experimental)'
complete -c astyle -l break-return-type -xa 'decl' -d 'Break the return type from the function name definitions'
complete -c astyle -l attach-return-type -xa 'decl' -d 'Attach the return type to the function name definitions'
...
complete -c astyle -l max-code-length-mode -xa 'code total ignore-side-comments' -d 'Determines how line length is measured'
...
complete -c astyle -l mode -xa 'c java cs objc js jsx ts tsx go rust kotlin swift dart scala gsc ghc' -d 'Set input syntax mode'
complete -c astyle -l pad-method-prefix -xa 'none' -d 'Insert space padding after the \'-\' or \'+\' Objective-C method prefix'
complete -c astyle -l pad-return-type -xa 'none' -d 'Insert space padding after the Objective-C return type'
complete -c astyle -l pad-param-type -xa 'none' -d 'Insert space padding after the Objective-C param type'
...
complete -c astyle -l error-on-changes -d 'With --dry-run: Report any file reformat as error'
...
complete -c astyle -l preserve-ws -d 'Preserve whitespace near comma operators if squeeze-ws is not set'
complete -c astyle -l indent-lambda -d 'Indent C++ lambda functions (experimental, broken for complex fct bodies)'
complete -c astyle -l block-continuation -d 'Indent continuation lines one indent from the start of the statement'
complete -c astyle -l align-continuation -d 'Align continuation lines with an assignment or a paren'
complete -c astyle -l accept-empty-list -d 'With wildcard or -R: Do not report an empty input file list as error'
