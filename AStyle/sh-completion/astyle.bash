_astyle() {
    ...
    case "$prev" in
        ...
        --max-code-length-mode)
            ...
            ;;
        --mode)
            COMPREPLY=($(compgen -W "c java cs objc js jsx ts tsx go rust kotlin swift dart gsc ghc" -- "$cur"))
            return 0
            ;;
