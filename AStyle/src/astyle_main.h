...
namespace astyle {
//
// set the language mode of the formatter according to a file name suffix
...
private:	// functions
	...
	std::string getPathString(const std::filesystem::path& path, bool* lossy = nullptr) const;
