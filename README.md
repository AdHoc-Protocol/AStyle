...
**TypeScript, JSX, Go, Rust, Kotlin, Swift and Dart**, and formatting every language the way its own community
...
- **A lexer pass** (`AStyle/src/ASLexer.cpp`) protects every literal: template literals, regular expressions, JSX, raw,
  ...
  ended by a line break (JavaScript, TypeScript, Go, Kotlin, Swift) and the conditions without parens (Go, Rust, Swift).
- **The new languages**: TypeScript/TSX, JSX, Go, Rust, Kotlin, Swift and Dart, with the modes `ts`, `tsx`, `jsx`, `go`,
